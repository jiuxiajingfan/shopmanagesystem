...
public class GoodController {
    ...
    @RequestMapping("findrecord/{sid}")
    @ResponseBody
    public List<record> findRecord(@PathVariable("sid")Long sid, String dateFrom, String dateTo){
        ...
        return goodService.findRecord(sid,datefrom,dateto);
    }
